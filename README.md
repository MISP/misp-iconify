...
- `misp-galaxies` — the plain glyph.
- `misp-galaxies-orbit` — the glyph inside a dashed **orbital ring carrying a
  star**. Because a galaxy clusters related entities, the orbit is a
  `currentColor` cue (legible even at 16px) that marks an icon as a galaxy —
  echoing MISP's galaxy swirl — without crowding the glyph.
...
| Galaxy | Plain | Orbit | Font Awesome glyph | File |
|--------|-------|-------|--------------------|------|
| `360net` | <img src="./exports/png/2x/galaxies/360net.png" width="24" alt="360net galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/360net.png" width="24" alt="360net galaxy orbit" /> | `fa-solid:user-secret` | `360net.svg` |
| `agent-threat-rules` | <img src="./exports/png/2x/galaxies/agent-threat-rules.png" width="24" alt="agent-threat-rules galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/agent-threat-rules.png" width="24" alt="agent-threat-rules galaxy orbit" /> | `fa-solid:shield-virus` | `agent-threat-rules.svg` |
| `ammunitions` | <img src="./exports/png/2x/galaxies/ammunitions.png" width="24" alt="ammunitions galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/ammunitions.png" width="24" alt="ammunitions galaxy orbit" /> | `fa-solid:battery-full` | `ammunitions.svg` |
| `android` | <img src="./exports/png/2x/galaxies/android.png" width="24" alt="android galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/android.png" width="24" alt="android galaxy orbit" /> | `fa-brands:android` | `android.svg` |
| `atrm` | <img src="./exports/png/2x/galaxies/atrm.png" width="24" alt="atrm galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/atrm.png" width="24" alt="atrm galaxy orbit" /> | `fa-solid:map` | `atrm.svg` |
| `attck4fraud` | <img src="./exports/png/2x/galaxies/attck4fraud.png" width="24" alt="attck4fraud galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/attck4fraud.png" width="24" alt="attck4fraud galaxy orbit" /> | `fa-solid:map` | `attck4fraud.svg` |
| `backdoor` | <img src="./exports/png/2x/galaxies/backdoor.png" width="24" alt="backdoor galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/backdoor.png" width="24" alt="backdoor galaxy orbit" /> | `fa-solid:door-open` | `backdoor.svg` |
| `banker` | <img src="./exports/png/2x/galaxies/banker.png" width="24" alt="banker galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/banker.png" width="24" alt="banker galaxy orbit" /> | `fa-solid:dollar-sign` | `banker.svg` |
| `bhadra-framework` | <img src="./exports/png/2x/galaxies/bhadra-framework.png" width="24" alt="bhadra-framework galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/bhadra-framework.png" width="24" alt="bhadra-framework galaxy orbit" /> | `fa-solid:mobile` | `bhadra-framework.svg` |
| `bitns` | <img src="./exports/png/2x/galaxies/bitns.png" width="24" alt="bitns galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/bitns.png" width="24" alt="bitns galaxy orbit" /> | `fa-solid:user-tie` | `bitns.svg` |
| `botnet` | <img src="./exports/png/2x/galaxies/botnet.png" width="24" alt="botnet galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/botnet.png" width="24" alt="botnet galaxy orbit" /> | `fa-solid:sitemap` | `botnet.svg` |
| `branded-vulnerability` | <img src="./exports/png/2x/galaxies/branded-vulnerability.png" width="24" alt="branded-vulnerability galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/branded-vulnerability.png" width="24" alt="branded-vulnerability galaxy orbit" /> | `fa-solid:bug` | `branded-vulnerability.svg` |
| `cancer` | <img src="./exports/png/2x/galaxies/cancer.png" width="24" alt="cancer galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/cancer.png" width="24" alt="cancer galaxy orbit" /> | `fa-brands:android` | `cancer.svg` |
| `cert-eu-govsector` | <img src="./exports/png/2x/galaxies/cert-eu-govsector.png" width="24" alt="cert-eu-govsector galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/cert-eu-govsector.png" width="24" alt="cert-eu-govsector galaxy orbit" /> | `fa-solid:globe` | `cert-eu-govsector.svg` |
| `china-defence-universities` | <img src="./exports/png/2x/galaxies/china-defence-universities.png" width="24" alt="china-defence-universities galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/china-defence-universities.png" width="24" alt="china-defence-universities galaxy orbit" /> | `fa-solid:globe` | `china-defence-universities.svg` |
| `cloak` | <img src="./exports/png/2x/galaxies/cloak.png" width="24" alt="cloak galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/cloak.png" width="24" alt="cloak galaxy orbit" /> | `fa-solid:user-secret` | `cloak.svg` |
| `cmtmf-attack-pattern` | <img src="./exports/png/2x/galaxies/cmtmf-attack-pattern.png" width="24" alt="cmtmf-attack-pattern galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/cmtmf-attack-pattern.png" width="24" alt="cmtmf-attack-pattern galaxy orbit" /> | `fa-solid:mobile` | `cmtmf-attack-pattern.svg` |
| `country` | <img src="./exports/png/2x/galaxies/country.png" width="24" alt="country galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/country.png" width="24" alt="country galaxy orbit" /> | `fa-solid:globe` | `country.svg` |
| `cryptominers` | <img src="./exports/png/2x/galaxies/cryptominers.png" width="24" alt="cryptominers galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/cryptominers.png" width="24" alt="cryptominers galaxy orbit" /> | `fa-brands:optin-monster` | `cryptominers.svg` |
| `cti-cmm-1-3` | <img src="./exports/png/2x/galaxies/cti-cmm-1-3.png" width="24" alt="cti-cmm-1-3 galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/cti-cmm-1-3.png" width="24" alt="cti-cmm-1-3 galaxy orbit" /> | `fa-solid:map` | `cti-cmm-1-3.svg` |
| `cyfun-assurance-requirements-2023` | <img src="./exports/png/2x/galaxies/cyfun-assurance-requirements-2023.png" width="24" alt="cyfun-assurance-requirements-2023 galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/cyfun-assurance-requirements-2023.png" width="24" alt="cyfun-assurance-requirements-2023 galaxy orbit" /> | `fa-solid:map` | `cyfun-assurance-requirements-2023.svg` |
| `cyfun-control-catalogue-2023` | <img src="./exports/png/2x/galaxies/cyfun-control-catalogue-2023.png" width="24" alt="cyfun-control-catalogue-2023 galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/cyfun-control-catalogue-2023.png" width="24" alt="cyfun-control-catalogue-2023 galaxy orbit" /> | `fa-solid:list` | `cyfun-control-catalogue-2023.svg` |
| `dima-techniques` | <img src="./exports/png/2x/galaxies/dima-techniques.png" width="24" alt="dima-techniques galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/dima-techniques.png" width="24" alt="dima-techniques galaxy orbit" /> | `fa-solid:project-diagram` | `dima-techniques.svg` |
| `disarm-actortypes` | <img src="./exports/png/2x/galaxies/disarm-actortypes.png" width="24" alt="disarm-actortypes galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/disarm-actortypes.png" width="24" alt="disarm-actortypes galaxy orbit" /> | `fa-solid:user-secret` | `disarm-actortypes.svg` |
| `disarm-countermeasures` | <img src="./exports/png/2x/galaxies/disarm-countermeasures.png" width="24" alt="disarm-countermeasures galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/disarm-countermeasures.png" width="24" alt="disarm-countermeasures galaxy orbit" /> | `fa-solid:shield-alt` | `disarm-countermeasures.svg` |
| `disarm-detections` | <img src="./exports/png/2x/galaxies/disarm-detections.png" width="24" alt="disarm-detections galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/disarm-detections.png" width="24" alt="disarm-detections galaxy orbit" /> | `fa-solid:bell` | `disarm-detections.svg` |
| `disarm-techniques` | <img src="./exports/png/2x/galaxies/disarm-techniques.png" width="24" alt="disarm-techniques galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/disarm-techniques.png" width="24" alt="disarm-techniques galaxy orbit" /> | `fa-solid:map` | `disarm-techniques.svg` |
| `election-guidelines` | <img src="./exports/png/2x/galaxies/election-guidelines.png" width="24" alt="election-guidelines galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/election-guidelines.png" width="24" alt="election-guidelines galaxy orbit" /> | `fa-solid:map` | `election-guidelines.svg` |
| `entity` | <img src="./exports/png/2x/galaxies/entity.png" width="24" alt="entity galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/entity.png" width="24" alt="entity galaxy orbit" /> | `fa-solid:user` | `entity.svg` |
| `exercise-world` | <img src="./exports/png/2x/galaxies/exercise-world.png" width="24" alt="exercise-world galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/exercise-world.png" width="24" alt="exercise-world galaxy orbit" /> | `fa-solid:globe` | `exercise-world.svg` |
| `exploit-kit` | <img src="./exports/png/2x/galaxies/exploit-kit.png" width="24" alt="exploit-kit galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/exploit-kit.png" width="24" alt="exploit-kit galaxy orbit" /> | `fa-brands:internet-explorer` | `exploit-kit.svg` |
| `firearms` | <img src="./exports/png/2x/galaxies/firearms.png" width="24" alt="firearms galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/firearms.png" width="24" alt="firearms galaxy orbit" /> | `fa-solid:fire` | `firearms.svg` |
| `first-csirt-services-framework` | <img src="./exports/png/2x/galaxies/first-csirt-services-framework.png" width="24" alt="first-csirt-services-framework galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/first-csirt-services-framework.png" width="24" alt="first-csirt-services-framework galaxy orbit" /> | `fa-solid:user` | `first-csirt-services-framework.svg` |
| `first-dns` | <img src="./exports/png/2x/galaxies/first-dns.png" width="24" alt="first-dns galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/first-dns.png" width="24" alt="first-dns galaxy orbit" /> | `fa-solid:database` | `first-dns.svg` |
| `gsma-motif` | <img src="./exports/png/2x/galaxies/gsma-motif.png" width="24" alt="gsma-motif galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/gsma-motif.png" width="24" alt="gsma-motif galaxy orbit" /> | `fa-solid:user-shield` | `gsma-motif.svg` |
| `handicap` | <img src="./exports/png/2x/galaxies/handicap.png" width="24" alt="handicap galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/handicap.png" width="24" alt="handicap galaxy orbit" /> | `fa-solid:wheelchair` | `handicap.svg` |
| `human-kill-chain` | <img src="./exports/png/2x/galaxies/human-kill-chain.png" width="24" alt="human-kill-chain galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/human-kill-chain.png" width="24" alt="human-kill-chain galaxy orbit" /> | `fa-solid:people-arrows` | `human-kill-chain.svg` |
| `intelligence-agencies` | <img src="./exports/png/2x/galaxies/intelligence-agencies.png" width="24" alt="intelligence-agencies galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/intelligence-agencies.png" width="24" alt="intelligence-agencies galaxy orbit" /> | `fa-solid:user-ninja` | `intelligence-agencies.svg` |
| `interpol-dwva` | <img src="./exports/png/2x/galaxies/interpol-dwva.png" width="24" alt="interpol-dwva galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/interpol-dwva.png" width="24" alt="interpol-dwva galaxy orbit" /> | `fa-solid:user-secret` | `interpol-dwva.svg` |
| `it-infrastructure-equipment` | <img src="./exports/png/2x/galaxies/it-infrastructure-equipment.png" width="24" alt="it-infrastructure-equipment galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/it-infrastructure-equipment.png" width="24" alt="it-infrastructure-equipment galaxy orbit" /> | `fa-solid:server` | `it-infrastructure-equipment.svg` |
| `malpedia` | <img src="./exports/png/2x/galaxies/malpedia.png" width="24" alt="malpedia galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/malpedia.png" width="24" alt="malpedia galaxy orbit" /> | `fa-solid:shield-virus` | `malpedia.svg` |
| `microsoft-activity-group` | <img src="./exports/png/2x/galaxies/microsoft-activity-group.png" width="24" alt="microsoft-activity-group galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/microsoft-activity-group.png" width="24" alt="microsoft-activity-group galaxy orbit" /> | `fa-solid:user-secret` | `microsoft-activity-group.svg` |
| `misinfosec-amitt-misinformation-pattern` | <img src="./exports/png/2x/galaxies/misinfosec-amitt-misinformation-pattern.png" width="24" alt="misinfosec-amitt-misinformation-pattern galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/misinfosec-amitt-misinformation-pattern.png" width="24" alt="misinfosec-amitt-misinformation-pattern galaxy orbit" /> | `fa-solid:map` | `misinfosec-amitt-misinformation-pattern.svg` |
| `mitre-analytic` | <img src="./exports/png/2x/galaxies/mitre-analytic.png" width="24" alt="mitre-analytic galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/mitre-analytic.png" width="24" alt="mitre-analytic galaxy orbit" /> | `fa-solid:shield-alt` | `mitre-analytic.svg` |
| `mitre-atlas-attack-pattern` | <img src="./exports/png/2x/galaxies/mitre-atlas-attack-pattern.png" width="24" alt="mitre-atlas-attack-pattern galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/mitre-atlas-attack-pattern.png" width="24" alt="mitre-atlas-attack-pattern galaxy orbit" /> | `fa-solid:map` | `mitre-atlas-attack-pattern.svg` |
| `mitre-atlas-course-of-action` | <img src="./exports/png/2x/galaxies/mitre-atlas-course-of-action.png" width="24" alt="mitre-atlas-course-of-action galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/mitre-atlas-course-of-action.png" width="24" alt="mitre-atlas-course-of-action galaxy orbit" /> | `fa-solid:link` | `mitre-atlas-course-of-action.svg` |
| `mitre-attack-pattern` | <img src="./exports/png/2x/galaxies/mitre-attack-pattern.png" width="24" alt="mitre-attack-pattern galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/mitre-attack-pattern.png" width="24" alt="mitre-attack-pattern galaxy orbit" /> | `fa-solid:map` | `mitre-attack-pattern.svg` |
| `mitre-course-of-action` | <img src="./exports/png/2x/galaxies/mitre-course-of-action.png" width="24" alt="mitre-course-of-action galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/mitre-course-of-action.png" width="24" alt="mitre-course-of-action galaxy orbit" /> | `fa-solid:link` | `mitre-course-of-action.svg` |
| `mitre-d3fend` | <img src="./exports/png/2x/galaxies/mitre-d3fend.png" width="24" alt="mitre-d3fend galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/mitre-d3fend.png" width="24" alt="mitre-d3fend galaxy orbit" /> | `fa-solid:user-shield` | `mitre-d3fend.svg` |
| `mitre-data-component` | <img src="./exports/png/2x/galaxies/mitre-data-component.png" width="24" alt="mitre-data-component galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/mitre-data-component.png" width="24" alt="mitre-data-component galaxy orbit" /> | `fa-solid:sitemap` | `mitre-data-component.svg` |
| `mitre-data-source` | <img src="./exports/png/2x/galaxies/mitre-data-source.png" width="24" alt="mitre-data-source galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/mitre-data-source.png" width="24" alt="mitre-data-source galaxy orbit" /> | `fa-solid:sitemap` | `mitre-data-source.svg` |
| `mitre-detection-strategy` | <img src="./exports/png/2x/galaxies/mitre-detection-strategy.png" width="24" alt="mitre-detection-strategy galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/mitre-detection-strategy.png" width="24" alt="mitre-detection-strategy galaxy orbit" /> | `fa-solid:shield-alt` | `mitre-detection-strategy.svg` |
| `mitre-engage-framework` | <img src="./exports/png/2x/galaxies/mitre-engage-framework.png" width="24" alt="mitre-engage-framework galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/mitre-engage-framework.png" width="24" alt="mitre-engage-framework galaxy orbit" /> | `fa-solid:user-secret` | `mitre-engage-framework.svg` |
| `mitre-enterprise-attack-attack-pattern` | <img src="./exports/png/2x/galaxies/mitre-enterprise-attack-attack-pattern.png" width="24" alt="mitre-enterprise-attack-attack-pattern galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/mitre-enterprise-attack-attack-pattern.png" width="24" alt="mitre-enterprise-attack-attack-pattern galaxy orbit" /> | `fa-solid:map` | `mitre-enterprise-attack-attack-pattern.svg` |
| `mitre-enterprise-attack-course-of-action` | <img src="./exports/png/2x/galaxies/mitre-enterprise-attack-course-of-action.png" width="24" alt="mitre-enterprise-attack-course-of-action galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/mitre-enterprise-attack-course-of-action.png" width="24" alt="mitre-enterprise-attack-course-of-action galaxy orbit" /> | `fa-solid:link` | `mitre-enterprise-attack-course-of-action.svg` |
| `mitre-enterprise-attack-intrusion-set` | <img src="./exports/png/2x/galaxies/mitre-enterprise-attack-intrusion-set.png" width="24" alt="mitre-enterprise-attack-intrusion-set galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/mitre-enterprise-attack-intrusion-set.png" width="24" alt="mitre-enterprise-attack-intrusion-set galaxy orbit" /> | `fa-solid:user-secret` | `mitre-enterprise-attack-intrusion-set.svg` |
| `mitre-enterprise-attack-malware` | <img src="./exports/png/2x/galaxies/mitre-enterprise-attack-malware.png" width="24" alt="mitre-enterprise-attack-malware galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/mitre-enterprise-attack-malware.png" width="24" alt="mitre-enterprise-attack-malware galaxy orbit" /> | `fa-brands:optin-monster` | `mitre-enterprise-attack-malware.svg` |
| `mitre-enterprise-attack-tool` | <img src="./exports/png/2x/galaxies/mitre-enterprise-attack-tool.png" width="24" alt="mitre-enterprise-attack-tool galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/mitre-enterprise-attack-tool.png" width="24" alt="mitre-enterprise-attack-tool galaxy orbit" /> | `fa-solid:gavel` | `mitre-enterprise-attack-tool.svg` |
| `mitre-fraud-framework` | <img src="./exports/png/2x/galaxies/mitre-fraud-framework.png" width="24" alt="mitre-fraud-framework galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/mitre-fraud-framework.png" width="24" alt="mitre-fraud-framework galaxy orbit" /> | `fa-solid:map` | `mitre-fraud-framework.svg` |
| `mitre-ics-assets` | <img src="./exports/png/2x/galaxies/mitre-ics-assets.png" width="24" alt="mitre-ics-assets galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/mitre-ics-assets.png" width="24" alt="mitre-ics-assets galaxy orbit" /> | `fa-solid:certificate` | `mitre-ics-assets.svg` |
| `mitre-ics-groups` | <img src="./exports/png/2x/galaxies/mitre-ics-groups.png" width="24" alt="mitre-ics-groups galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/mitre-ics-groups.png" width="24" alt="mitre-ics-groups galaxy orbit" /> | `fa-solid:skull-crossbones` | `mitre-ics-groups.svg` |
| `mitre-ics-levels` | <img src="./exports/png/2x/galaxies/mitre-ics-levels.png" width="24" alt="mitre-ics-levels galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/mitre-ics-levels.png" width="24" alt="mitre-ics-levels galaxy orbit" /> | `fa-solid:layer-group` | `mitre-ics-levels.svg` |
| `mitre-ics-software` | <img src="./exports/png/2x/galaxies/mitre-ics-software.png" width="24" alt="mitre-ics-software galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/mitre-ics-software.png" width="24" alt="mitre-ics-software galaxy orbit" /> | `fa-solid:file-code` | `mitre-ics-software.svg` |
| `mitre-ics-tactics` | <img src="./exports/png/2x/galaxies/mitre-ics-tactics.png" width="24" alt="mitre-ics-tactics galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/mitre-ics-tactics.png" width="24" alt="mitre-ics-tactics galaxy orbit" /> | `fa-solid:chess-pawn` | `mitre-ics-tactics.svg` |
| `mitre-ics-techniques` | <img src="./exports/png/2x/galaxies/mitre-ics-techniques.png" width="24" alt="mitre-ics-techniques galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/mitre-ics-techniques.png" width="24" alt="mitre-ics-techniques galaxy orbit" /> | `fa-solid:user-ninja` | `mitre-ics-techniques.svg` |
| `mitre-intrusion-set` | <img src="./exports/png/2x/galaxies/mitre-intrusion-set.png" width="24" alt="mitre-intrusion-set galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/mitre-intrusion-set.png" width="24" alt="mitre-intrusion-set galaxy orbit" /> | `fa-solid:user-secret` | `mitre-intrusion-set.svg` |
| `mitre-malware` | <img src="./exports/png/2x/galaxies/mitre-malware.png" width="24" alt="mitre-malware galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/mitre-malware.png" width="24" alt="mitre-malware galaxy orbit" /> | `fa-brands:optin-monster` | `mitre-malware.svg` |
| `mitre-mobile-attack-attack-pattern` | <img src="./exports/png/2x/galaxies/mitre-mobile-attack-attack-pattern.png" width="24" alt="mitre-mobile-attack-attack-pattern galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/mitre-mobile-attack-attack-pattern.png" width="24" alt="mitre-mobile-attack-attack-pattern galaxy orbit" /> | `fa-solid:map` | `mitre-mobile-attack-attack-pattern.svg` |
| `mitre-mobile-attack-course-of-action` | <img src="./exports/png/2x/galaxies/mitre-mobile-attack-course-of-action.png" width="24" alt="mitre-mobile-attack-course-of-action galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/mitre-mobile-attack-course-of-action.png" width="24" alt="mitre-mobile-attack-course-of-action galaxy orbit" /> | `fa-solid:link` | `mitre-mobile-attack-course-of-action.svg` |
| `mitre-mobile-attack-intrusion-set` | <img src="./exports/png/2x/galaxies/mitre-mobile-attack-intrusion-set.png" width="24" alt="mitre-mobile-attack-intrusion-set galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/mitre-mobile-attack-intrusion-set.png" width="24" alt="mitre-mobile-attack-intrusion-set galaxy orbit" /> | `fa-solid:user-secret` | `mitre-mobile-attack-intrusion-set.svg` |
| `mitre-mobile-attack-malware` | <img src="./exports/png/2x/galaxies/mitre-mobile-attack-malware.png" width="24" alt="mitre-mobile-attack-malware galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/mitre-mobile-attack-malware.png" width="24" alt="mitre-mobile-attack-malware galaxy orbit" /> | `fa-brands:optin-monster` | `mitre-mobile-attack-malware.svg` |
| `mitre-mobile-attack-tool` | <img src="./exports/png/2x/galaxies/mitre-mobile-attack-tool.png" width="24" alt="mitre-mobile-attack-tool galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/mitre-mobile-attack-tool.png" width="24" alt="mitre-mobile-attack-tool galaxy orbit" /> | `fa-solid:gavel` | `mitre-mobile-attack-tool.svg` |
| `mitre-pre-attack-attack-pattern` | <img src="./exports/png/2x/galaxies/mitre-pre-attack-attack-pattern.png" width="24" alt="mitre-pre-attack-attack-pattern galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/mitre-pre-attack-attack-pattern.png" width="24" alt="mitre-pre-attack-attack-pattern galaxy orbit" /> | `fa-solid:map` | `mitre-pre-attack-attack-pattern.svg` |
| `mitre-pre-attack-intrusion-set` | <img src="./exports/png/2x/galaxies/mitre-pre-attack-intrusion-set.png" width="24" alt="mitre-pre-attack-intrusion-set galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/mitre-pre-attack-intrusion-set.png" width="24" alt="mitre-pre-attack-intrusion-set galaxy orbit" /> | `fa-solid:user-secret` | `mitre-pre-attack-intrusion-set.svg` |
| `mitre-tool` | <img src="./exports/png/2x/galaxies/mitre-tool.png" width="24" alt="mitre-tool galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/mitre-tool.png" width="24" alt="mitre-tool galaxy orbit" /> | `fa-solid:gavel` | `mitre-tool.svg` |
| `nace` | <img src="./exports/png/2x/galaxies/nace.png" width="24" alt="nace galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/nace.png" width="24" alt="nace galaxy orbit" /> | `fa-solid:industry` | `nace.svg` |
| `naics` | <img src="./exports/png/2x/galaxies/naics.png" width="24" alt="naics galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/naics.png" width="24" alt="naics galaxy orbit" /> | `fa-solid:industry` | `naics.svg` |
| `nato` | <img src="./exports/png/2x/galaxies/nato.png" width="24" alt="nato galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/nato.png" width="24" alt="nato galaxy orbit" /> | `fa-solid:industry` | `nato.svg` |
| `nice-framework-competency-areas` | <img src="./exports/png/2x/galaxies/nice-framework-competency-areas.png" width="24" alt="nice-framework-competency-areas galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/nice-framework-competency-areas.png" width="24" alt="nice-framework-competency-areas galaxy orbit" /> | `fa-solid:user` | `nice-framework-competency-areas.svg` |
| `nice-framework-knowledges` | <img src="./exports/png/2x/galaxies/nice-framework-knowledges.png" width="24" alt="nice-framework-knowledges galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/nice-framework-knowledges.png" width="24" alt="nice-framework-knowledges galaxy orbit" /> | `fa-solid:user` | `nice-framework-knowledges.svg` |
| `nice-framework-opm-codes` | <img src="./exports/png/2x/galaxies/nice-framework-opm-codes.png" width="24" alt="nice-framework-opm-codes galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/nice-framework-opm-codes.png" width="24" alt="nice-framework-opm-codes galaxy orbit" /> | `fa-solid:user` | `nice-framework-opm-codes.svg` |
| `nice-framework-skills` | <img src="./exports/png/2x/galaxies/nice-framework-skills.png" width="24" alt="nice-framework-skills galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/nice-framework-skills.png" width="24" alt="nice-framework-skills galaxy orbit" /> | `fa-solid:user` | `nice-framework-skills.svg` |
| `nice-framework-tasks` | <img src="./exports/png/2x/galaxies/nice-framework-tasks.png" width="24" alt="nice-framework-tasks galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/nice-framework-tasks.png" width="24" alt="nice-framework-tasks galaxy orbit" /> | `fa-solid:user` | `nice-framework-tasks.svg` |
| `nice-framework-work-roles` | <img src="./exports/png/2x/galaxies/nice-framework-work-roles.png" width="24" alt="nice-framework-work-roles galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/nice-framework-work-roles.png" width="24" alt="nice-framework-work-roles galaxy orbit" /> | `fa-solid:user` | `nice-framework-work-roles.svg` |
| `o365-exchange-techniques` | <img src="./exports/png/2x/galaxies/o365-exchange-techniques.png" width="24" alt="o365-exchange-techniques galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/o365-exchange-techniques.png" width="24" alt="o365-exchange-techniques galaxy orbit" /> | `fa-solid:map` | `o365-exchange-techniques.svg` |
| `online-service` | <img src="./exports/png/2x/galaxies/online-service.png" width="24" alt="online-service galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/online-service.png" width="24" alt="online-service galaxy orbit" /> | `fa-solid:cloud` | `online-service.svg` |
| `operating-system` | <img src="./exports/png/2x/galaxies/operating-system.png" width="24" alt="operating-system galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/operating-system.png" width="24" alt="operating-system galaxy orbit" /> | `fa-solid:laptop` | `operating-system.svg` |
| `plot4ai` | <img src="./exports/png/2x/galaxies/plot4ai.png" width="24" alt="plot4ai galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/plot4ai.png" width="24" alt="plot4ai galaxy orbit" /> | `fa-solid:brain` | `plot4ai.svg` |
| `preventive-measure` | <img src="./exports/png/2x/galaxies/preventive-measure.png" width="24" alt="preventive-measure galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/preventive-measure.png" width="24" alt="preventive-measure galaxy orbit" /> | `fa-solid:shield-alt` | `preventive-measure.svg` |
| `producer` | <img src="./exports/png/2x/galaxies/producer.png" width="24" alt="producer galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/producer.png" width="24" alt="producer galaxy orbit" /> | `fa-solid:book` | `producer.svg` |
| `ransomware` | <img src="./exports/png/2x/galaxies/ransomware.png" width="24" alt="ransomware galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/ransomware.png" width="24" alt="ransomware galaxy orbit" /> | `fa-brands:btc` | `ransomware.svg` |
| `rat` | <img src="./exports/png/2x/galaxies/rat.png" width="24" alt="rat galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/rat.png" width="24" alt="rat galaxy orbit" /> | `fa-solid:eye` | `rat.svg` |
| `region` | <img src="./exports/png/2x/galaxies/region.png" width="24" alt="region galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/region.png" width="24" alt="region galaxy orbit" /> | `fa-solid:globe-europe` | `region.svg` |
| `rmm-tool` | <img src="./exports/png/2x/galaxies/rmm-tool.png" width="24" alt="rmm-tool galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/rmm-tool.png" width="24" alt="rmm-tool galaxy orbit" /> | `fa-solid:user-secret` | `rmm-tool.svg` |
| `rsit` | <img src="./exports/png/2x/galaxies/rsit.png" width="24" alt="rsit galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/rsit.png" width="24" alt="rsit galaxy orbit" /> | `fa-solid:map` | `rsit.svg` |
| `scor-about` | <img src="./exports/png/2x/galaxies/scor-about.png" width="24" alt="scor-about galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/scor-about.png" width="24" alt="scor-about galaxy orbit" /> | `fa-solid:info` | `scor-about.svg` |
| `scor-attack-paths` | <img src="./exports/png/2x/galaxies/scor-attack-paths.png" width="24" alt="scor-attack-paths galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/scor-attack-paths.png" width="24" alt="scor-attack-paths galaxy orbit" /> | `fa-solid:project-diagram` | `scor-attack-paths.svg` |
| `scor-detection-signatures` | <img src="./exports/png/2x/galaxies/scor-detection-signatures.png" width="24" alt="scor-detection-signatures galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/scor-detection-signatures.png" width="24" alt="scor-detection-signatures galaxy orbit" /> | `fa-solid:search` | `scor-detection-signatures.svg` |
| `scor-exposure-domain` | <img src="./exports/png/2x/galaxies/scor-exposure-domain.png" width="24" alt="scor-exposure-domain galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/scor-exposure-domain.png" width="24" alt="scor-exposure-domain galaxy orbit" /> | `fa-solid:shield-alt` | `scor-exposure-domain.svg` |
| `scor-incidents` | <img src="./exports/png/2x/galaxies/scor-incidents.png" width="24" alt="scor-incidents galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/scor-incidents.png" width="24" alt="scor-incidents galaxy orbit" /> | `fa-solid:exclamation-triangle` | `scor-incidents.svg` |
| `scor-resilience-measures` | <img src="./exports/png/2x/galaxies/scor-resilience-measures.png" width="24" alt="scor-resilience-measures galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/scor-resilience-measures.png" width="24" alt="scor-resilience-measures galaxy orbit" /> | `fa-solid:shield-virus` | `scor-resilience-measures.svg` |
| `scor-tens` | <img src="./exports/png/2x/galaxies/scor-tens.png" width="24" alt="scor-tens galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/scor-tens.png" width="24" alt="scor-tens galaxy orbit" /> | `fa-solid:atom` | `scor-tens.svg` |
| `sector` | <img src="./exports/png/2x/galaxies/sector.png" width="24" alt="sector galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/sector.png" width="24" alt="sector galaxy orbit" /> | `fa-solid:industry` | `sector.svg` |
| `sigma-rules` | <img src="./exports/png/2x/galaxies/sigma-rules.png" width="24" alt="sigma-rules galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/sigma-rules.png" width="24" alt="sigma-rules galaxy orbit" /> | `fa-solid:link` | `sigma-rules.svg` |
| `social-dark-patterns` | <img src="./exports/png/2x/galaxies/social-dark-patterns.png" width="24" alt="social-dark-patterns galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/social-dark-patterns.png" width="24" alt="social-dark-patterns galaxy orbit" /> | `fa-solid:link` | `social-dark-patterns.svg` |
| `sod-matrix` | <img src="./exports/png/2x/galaxies/sod-matrix.png" width="24" alt="sod-matrix galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/sod-matrix.png" width="24" alt="sod-matrix galaxy orbit" /> | `fa-solid:map` | `sod-matrix.svg` |
| `software-vendor` | <img src="./exports/png/2x/galaxies/software-vendor.png" width="24" alt="software-vendor galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/software-vendor.png" width="24" alt="software-vendor galaxy orbit" /> | `fa-solid:building` | `software-vendor.svg` |
| `sparta-mitigations` | <img src="./exports/png/2x/galaxies/sparta-mitigations.png" width="24" alt="sparta-mitigations galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/sparta-mitigations.png" width="24" alt="sparta-mitigations galaxy orbit" /> | `fa-solid:shield-alt` | `sparta-mitigations.svg` |
| `sparta-tactics` | <img src="./exports/png/2x/galaxies/sparta-tactics.png" width="24" alt="sparta-tactics galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/sparta-tactics.png" width="24" alt="sparta-tactics galaxy orbit" /> | `fa-solid:map` | `sparta-tactics.svg` |
| `sparta-techniques` | <img src="./exports/png/2x/galaxies/sparta-techniques.png" width="24" alt="sparta-techniques galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/sparta-techniques.png" width="24" alt="sparta-techniques galaxy orbit" /> | `fa-solid:map` | `sparta-techniques.svg` |
| `stalkerware` | <img src="./exports/png/2x/galaxies/stalkerware.png" width="24" alt="stalkerware galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/stalkerware.png" width="24" alt="stalkerware galaxy orbit" /> | `fa-solid:eye` | `stalkerware.svg` |
| `stealer` | <img src="./exports/png/2x/galaxies/stealer.png" width="24" alt="stealer galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/stealer.png" width="24" alt="stealer galaxy orbit" /> | `fa-solid:key` | `stealer.svg` |
| `surveillance-vendor` | <img src="./exports/png/2x/galaxies/surveillance-vendor.png" width="24" alt="surveillance-vendor galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/surveillance-vendor.png" width="24" alt="surveillance-vendor galaxy orbit" /> | `fa-solid:user-shield` | `surveillance-vendor.svg` |
| `target-information` | <img src="./exports/png/2x/galaxies/target-information.png" width="24" alt="target-information galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/target-information.png" width="24" alt="target-information galaxy orbit" /> | `fa-solid:bullseye` | `target-information.svg` |
| `taxonomy-of-fraud` | <img src="./exports/png/2x/galaxies/taxonomy-of-fraud.png" width="24" alt="taxonomy-of-fraud galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/taxonomy-of-fraud.png" width="24" alt="taxonomy-of-fraud galaxy orbit" /> | `fa-solid:money-bill-wave` | `taxonomy-of-fraud.svg` |
| `tds` | <img src="./exports/png/2x/galaxies/tds.png" width="24" alt="tds galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/tds.png" width="24" alt="tds galaxy orbit" /> | `fa-solid:cart-arrow-down` | `tds.svg` |
| `tea-matrix` | <img src="./exports/png/2x/galaxies/tea-matrix.png" width="24" alt="tea-matrix galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/tea-matrix.png" width="24" alt="tea-matrix galaxy orbit" /> | `fa-solid:map` | `tea-matrix.svg` |
| `terrorist-groups` | <img src="./exports/png/2x/galaxies/terrorist-groups.png" width="24" alt="terrorist-groups galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/terrorist-groups.png" width="24" alt="terrorist-groups galaxy orbit" /> | `fa-solid:user-secret` | `terrorist-groups.svg` |
| `threat-actor` | <img src="./exports/png/2x/galaxies/threat-actor.png" width="24" alt="threat-actor galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/threat-actor.png" width="24" alt="threat-actor galaxy orbit" /> | `fa-solid:user-secret` | `threat-actor.svg` |
| `tidal-campaigns` | <img src="./exports/png/2x/galaxies/tidal-campaigns.png" width="24" alt="tidal-campaigns galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/tidal-campaigns.png" width="24" alt="tidal-campaigns galaxy orbit" /> | `fa-solid:bullhorn` | `tidal-campaigns.svg` |
| `tidal-groups` | <img src="./exports/png/2x/galaxies/tidal-groups.png" width="24" alt="tidal-groups galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/tidal-groups.png" width="24" alt="tidal-groups galaxy orbit" /> | `fa-solid:user-secret` | `tidal-groups.svg` |
| `tidal-references` | <img src="./exports/png/2x/galaxies/tidal-references.png" width="24" alt="tidal-references galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/tidal-references.png" width="24" alt="tidal-references galaxy orbit" /> | `fa-solid:list` | `tidal-references.svg` |
| `tidal-software` | <img src="./exports/png/2x/galaxies/tidal-software.png" width="24" alt="tidal-software galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/tidal-software.png" width="24" alt="tidal-software galaxy orbit" /> | `fa-solid:file-code` | `tidal-software.svg` |
| `tidal-tactic` | <img src="./exports/png/2x/galaxies/tidal-tactic.png" width="24" alt="tidal-tactic galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/tidal-tactic.png" width="24" alt="tidal-tactic galaxy orbit" /> | `fa-solid:map` | `tidal-tactic.svg` |
| `tidal-technique` | <img src="./exports/png/2x/galaxies/tidal-technique.png" width="24" alt="tidal-technique galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/tidal-technique.png" width="24" alt="tidal-technique galaxy orbit" /> | `fa-solid:user-ninja` | `tidal-technique.svg` |
| `tmss` | <img src="./exports/png/2x/galaxies/tmss.png" width="24" alt="tmss galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/tmss.png" width="24" alt="tmss galaxy orbit" /> | `fa-solid:map` | `tmss.svg` |
| `tool` | <img src="./exports/png/2x/galaxies/tool.png" width="24" alt="tool galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/tool.png" width="24" alt="tool galaxy orbit" /> | `fa-brands:optin-monster` | `tool.svg` |
| `uavs` | <img src="./exports/png/2x/galaxies/uavs.png" width="24" alt="uavs galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/uavs.png" width="24" alt="uavs galaxy orbit" /> | `fa-solid:plane` | `uavs.svg` |
| `ukhsa-culture-collections` | <img src="./exports/png/2x/galaxies/ukhsa-culture-collections.png" width="24" alt="ukhsa-culture-collections galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/ukhsa-culture-collections.png" width="24" alt="ukhsa-culture-collections galaxy orbit" /> | `fa-solid:virus` | `ukhsa-culture-collections.svg` |
| `veris-framework` | <img src="./exports/png/2x/galaxies/veris-framework.png" width="24" alt="veris-framework galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/veris-framework.png" width="24" alt="veris-framework galaxy orbit" /> | `fa-solid:sitemap` | `veris-framework.svg` |
| `wiper` | <img src="./exports/png/2x/galaxies/wiper.png" width="24" alt="wiper galaxy" /> | <img src="./exports/png/2x/galaxies-orbit/wiper.png" width="24" alt="wiper galaxy orbit" /> | `fa-solid:trash` | `wiper.svg` |
